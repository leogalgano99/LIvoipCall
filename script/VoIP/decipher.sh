...
sudo docker  exec agency ./util/decrypt.sh
...
sudo docker  exec agency rm /home/openli-testagency/CC_agency.pcap
sudo docker  exec agency rm /home/openli-testagency/CC_decipher.wav
sudo docker  exec agency rm /home/openli-testagency/CC_decipher.txt
sudo docker  exec agency rm /home/openli-testagency/CC_cipher.wav

sudo docker  exec collector rm /home/openli-coll/POI.pcap
sudo docker  exec mediator rm /home/openli-med/MDF.pcap
sudo docker  exec upf rm /open5gs/UPF.pcap
